...
uv run ./model-topics.py --llm --embed-labels --embed-bodies --embed-comments --embed-model "Qwen/Qwen3-Embedding-8B" --embed-batch-size 1 --min-cluster-size 10 --flash-attention "./datasets/$dataset.json"
